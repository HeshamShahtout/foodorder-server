...
import com.example.eatitserver.Common.DirectionJSONParser;
...
public class TrackingOrder extends FragmentActivity implements OnMapReadyCallback,
    ...
    private final static int LOCATION_PERMISSION_REQUEST = 10001;
    ...
    private void displayLocation() {
        ...
        else
        {
            ...
            if (mLastLocation != null)
            {
                ...
                //Add marker to location and move camera
